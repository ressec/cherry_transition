...
//    EntityIdentity toIdentity(ServerPersonEntity person);
//    ServerPersonEntity fromIdentity(EntityIdentity identity);
//    ClientPersonEntity toClient(ServerPersonEntity person);
//    ServerPersonEntity fromClient(ClientPersonEntity person);
//
//    /**
...
//     */
//    ServerPersonEntity mapClient(ClientPersonEntity entity, @Context CycleAvoidingMappingContext context, @Context ServerEntityFactory factory) throws EntityException;
//
//    /**
...
//     */
//    ServerPersonEntity copy(ServerPersonEntity persistent, @Context CycleAvoidingMappingContext context) throws EntityException;
//
//    /**
...
//     */
//    @Named("fromIdentity")
//    default ServerPersonEntity fromIdentity(final Identity identity, @Context ServerEntityFactory factory) throws DocumentException, EntityException
//    {
